...
# requested web port and credentials as soon as that file is available, before
# later update checks can launch the graphical game and fail on a headless host.
# Preserve its generated TLS configuration and certificates.
